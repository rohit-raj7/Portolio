...
export const ExperienceData = [
  ...
  },
  {
    ...
    description:
      "As a frontend intern, I worked with JavaScript and React to build interactive websites. I collaborated with APIs to fetch, manipulate, and display data, optimizing the user experience.",
    img: learningx,
    link:links,
